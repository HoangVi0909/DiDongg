...
export default function AdminScreen() {
  ...
  const menuItems = [
    { title: 'Quản lý sản phẩm', icon: '📦', color: '#3b82f6', route: '/AdminProducts' as const },
    { title: 'Quản lý đơn hàng', icon: '🛒', color: '#10b981', route: '/AdminOrders' as const },
    { title: 'Quản lý khách hàng', icon: '👥', color: '#f59e0b', route: '/AdminCustomers' as const },
    { title: 'Quản lý nhân viên', icon: '👔', color: '#8b5cf6', route: '/AdminStaff' as const },
    { title: 'Báo cáo thống kê', icon: '📊', color: '#ec4899', route: '/AdminReports' as const },
    { title: 'Cài đặt', icon: '⚙️', color: '#6b7280', route: '/AdminSettings' as const },
  ];
